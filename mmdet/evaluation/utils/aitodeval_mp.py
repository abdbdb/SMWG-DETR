...
from .aitodeval import AITODeval
from tqdm import tqdm


class AITODevalMP(AITODeval):
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            stats = []
            stats.append(_summarize(1, maxDets=self.params.maxDets[2]))
            ...
            stats.append(_summarize(1, areaRng='verytiny', maxDets=self.params.maxDets[2]))
            stats.append(_summarize(1, areaRng='tiny', maxDets=self.params.maxDets[2]))
            ...
            stats.append(_summarize(0, areaRng='verytiny', maxDets=self.params.maxDets[2]))
            stats.append(_summarize(0, areaRng='tiny', maxDets=self.params.maxDets[2]))
            ...
            stats.append(_summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP'))
            stats.append(_summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP_Localisation'))
            stats.append(_summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP_false_positive'))
            stats.append(_summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP_false_negative'))
            _summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP_thresholds')
