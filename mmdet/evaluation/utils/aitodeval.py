...
class AITODeval:
    ...
    def __init__(self, cocoGt=None, cocoDt=None, iouType='segm', logger=None):
        '''
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[1] = _summarize(1, maxDets=self.params.maxDets[1])  # 最大框为300时的map
            stats[2] = _summarize(1, iouThr=.5, maxDets=self.params.maxDets[2])
            stats[3] = _summarize(1, iouThr=.75, maxDets=self.params.maxDets[2])
            stats[4] = _summarize(1, areaRng='verytiny', maxDets=self.params.maxDets[2])
            stats[5] = _summarize(1, areaRng='tiny', maxDets=self.params.maxDets[2])
            ...
            stats[11] = _summarize(0, areaRng='verytiny', maxDets=self.params.maxDets[2])
            stats[12] = _summarize(0, areaRng='tiny', maxDets=self.params.maxDets[2])
            ...
            stats[15] = _summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP')
            stats[16] = _summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP_Localisation')
            stats[17] = _summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP_false_positive')
            stats[18] = _summarize(-1, iouThr=.5, areaRng='all', maxDets=self.params.maxDets[2], lrp_type='oLRP_false_negative')
