...
from ..utils import AITODeval, AITODevalMP
...
class AITODMetric(BaseMetric):
    ...
    Args:
        ...
        classwise (bool): Whether to evaluate the metric class-wise.
            Defaults to False.  # 按类别评估，要是按类别评估的话，这块还得改
    ...
    def __init__(self,
                 ...
                 use_mp_eval: bool = False) -> None:  # 开启多线程
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for metric in self.metrics:
            ...
            if self.use_mp_eval:
                coco_eval = AITODevalMP(self._coco_api, coco_dt, iou_type)
            else:
                coco_eval = AITODeval(self._coco_api, coco_dt, iou_type, logger)
