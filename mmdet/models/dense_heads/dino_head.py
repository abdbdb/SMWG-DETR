...
class DINOHead(DeformableDETRHead):
    ...
    def loss(self, hidden_states: Tensor, references: List[Tensor],
        ...
        loss_inputs = outs + (enc_outputs_class, enc_outputs_coord,
                              batch_gt_instances, batch_img_metas, dn_meta, None, batch_data_samples)
    ...
    def _get_dn_targets_single(self, gt_instances: InstanceData,
                               img_meta: dict, batch_data_samples, dn_meta: Dict[str,
                                                             int]) -> tuple:
        ...
        if batch_data_samples.gt_instances.bboxes.size(0) > self.max_gt_bbox:
            gt_bboxes = gt_instances.bboxes[batch_data_samples.selected_gt]
            gt_labels = gt_instances.labels[batch_data_samples.selected_gt]
        else:
