...
from ..layers import SMWGDETRTransformerDecoder, SinePositionalEncoding
...
class SMWGDETR(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.decoder = SMWGDETRTransformerDecoder(**self.decoder)
    ...
    def pre_decoder(
        ...
        if self.training:
            dn_label_query, dn_bbox_query, dn_mask, dn_meta = \
                self.dn_query_generator(batch_data_samples, topk_coords.detach(), topk_score.detach().max(-1)[0].sigmoid())
